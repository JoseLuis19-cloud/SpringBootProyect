/*
* Función que rellena con ceros un campo hasta su longitud maxima
* 
* param objeto - campo del formulario
* param longitud - tamaño del campo
*/
     ...
     if (numCarac > valorMaximo)
         {
          ...
          alert("Ha excedido el valor de " + valorMaximo + " carácteres permitido para este campo");
